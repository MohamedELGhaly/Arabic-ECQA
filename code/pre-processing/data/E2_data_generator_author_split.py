...
train_df = pd.read_csv('Arabic-ECQA_data_train.csv', dtype='unicode', header=(0), error_bad_lines=False)
train_data = generate_data(train_df)
val_df = pd.read_csv('Arabic-ECQA_data_val.csv', dtype='unicode', header=(0), error_bad_lines=False)
val_data = generate_data(val_df)
test_df = pd.read_csv('Arabic-ECQA_data_test.csv', dtype='unicode', header=(0), error_bad_lines=False)
...
with open('ED_mixed.json', 'w') as fp:
    json.dump(mixed_data, fp, ensure_ascii=False)
...
with open('ED_cqa_train.json', 'w') as fp:
    json.dump(ED_train_data, fp, ensure_ascii=False)

with open('ED_cqa_val.json', 'w') as fp:
    json.dump(ED_val_data, fp,ensure_ascii=False)

with open('ED_cqa_test.json', 'w') as fp:
    json.dump(ED_test_data, fp, ensure_ascii=False)
